...
public class OutOfMemoryVsStackFlow {
    ...
    //1. /usr/lib/jvm/java-6-openjdk/bin/java -Xms512m -Xmx512m -Dfile.encoding=UTF-8 -classpath /home/anurag/workspace/LearnJava/bin jvm.memorymanagement.OutOfMemoryVsStackFlow > out
    //2. /usr/lib/jvm/java-6-openjdk/bin/java -Xms10m -Xmx10m -Dfile.encoding=UTF-8 -classpath /home/anurag/workspace/LearnJava/bin jvm.memorymanagement.OutOfMemoryVsStackFlow > out
    //3. /usr/lib/jvm/java-6-openjdk/bin/java -Xss12m -Xms10m -Xmx10m -Dfile.encoding=UTF-8 -classpath /home/anurag/workspace/LearnJava/bin jvm.memorymanagement.OutOfMemoryVsStackFlow > out
